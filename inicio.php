            ...
            <div class="form_divCon">
                <form class="" action="" method="post">
                    ...
                    <div class="">
                        ...
                        <input type="password" class="form-control" name="pesoPro">
                    </div>
                    <div class="">
                        <label  class="form-label">Categoria del Producto</label><br>
                        <select class="form_selec" values="idcategoria" required>
                            <option value="" disabled="" selected>Seleccionar</option>
                            <?php
                                include "modelo/conexion.php";
                                $sql=$conexion->query("select nombre_categoria from categoria");
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?= $datos->id_categoria ?>"><?= $datos->nombre_categoria ?></option>
                            <?php } ?>
                         </select>
                    </div>
                    <div class="">
                        <label  class="form-label">Marca del Producto</label><br>
                        <select class="form_selec" values="idmarca" required>
                            <option value="" disabled="" selected>Seleccionar</option>
                            <?php
                                include "modelo/conexion.php";
                                $sql=$conexion->query("select nombre_marca from marca");
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?= $datos->id_marca ?>"><?= $datos->nombre_marca ?></option>
                            <?php } ?>
                         </select>
                    </div>
                    <div class="">
                        <label  class="form-label">Proveedor del Producto</label><br>
                        <select class="form_selec" values="idproveedor" required>
                            <option value="" disabled="" selected>Seleccionar</option>
                            <?php
                                include "modelo/conexion.php";
                                $sql=$conexion->query("select nombres_proveedor,apellidos_proveedor from proveedor");
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?= $datos->id_proveedor ?>"><?= $datos->nombres_proveedor; echo " "; $datos->apellidos_proveedor; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="">
                        <label  class="form-label">Usuario que Registra el Producto</label><br>
                        <input type="text" class="form-control" name="idusuario" id="">
                    </div>
                    <div class="">
            ...
            <div class="form_divCon">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="">
                        ...
                        <select class="form_selec" values="" name="idRol" required>
                            <option value="" disabled="" selected>Seleccionar</option>
                            <?php
                                include "modelo/conexion.php";
                                $sql=$conexion->query("select nombre_rol from rol");
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?= $datos->id_rol ?>"><?= $datos->nombre_rol ?></option>
                            <?php } ?>
                         </select>
                    </div>
                ...
                <div class="">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                include "modelo/conexion.php";
                                $sql=$conexion->query("select * from usuario inner join rol
                                on usuario.id_rol=rol.id_rol");
                                //mistras existan datos se esjutara el WHILE
                                while($datos=$sql->fetch_object()){?>
                                    <tr>
                                        <th><?= $datos->id_usuario ?></th>
                                        <td><?= $datos->loginId_usuario ?></td>
                                        <td><?= $datos->Nombres_usuario ?></td>
                                        <td><?= $datos->Apellidos_usuario ?></td>
                                        <td><img src="datos:image/jpg;base64, <?= base64_decode($datos->foto_usuario)?>" alt=""></td>
                                        <td><?= $datos->constrasena_usuario ?></td>
